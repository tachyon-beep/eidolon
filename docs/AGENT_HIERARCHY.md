# Eidolon 5-Tier Agent Hierarchy

## Overview

Eidolon uses a sophisticated 5-tier hierarchical agent system for comprehensive code analysis. Each tier provides a different level of coordination, analysis, and control, creating a multi-dimensional view of code quality.
