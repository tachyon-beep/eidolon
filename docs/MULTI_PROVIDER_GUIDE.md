...
Eidolon now supports multiple LLM providers through a unified abstraction layer. You can easily switch between Anthropic Claude, OpenAI, OpenRouter, and any OpenAI-compatible API.
...
# Configure Eidolon to use Ollama
export LLM_PROVIDER="openai"
...
# Output:
# eidolon_ai_api_tokens_total{direction="input",model="..."} 1234
# eidolon_ai_api_tokens_total{direction="output",model="..."} 5678
```
