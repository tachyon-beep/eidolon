...
circuit_breaker_state = Gauge(
    'eidolon_circuit_breaker_state',
    'Circuit breaker state (0=closed, 1=half_open, 2=open)',
    ['name']
)

circuit_breaker_failures_total = Counter(
    'eidolon_circuit_breaker_failures_total',
    'Total circuit breaker failures',
    ['name']
)

circuit_breaker_successes_total = Counter(
    'eidolon_circuit_breaker_successes_total',
    'Total circuit breaker successes',
    ['name']
)

circuit_breaker_state_changes_total = Counter(
    'eidolon_circuit_breaker_state_changes_total',
...
cache_entries_total = Gauge(
    'eidolon_cache_entries_total',
    'Number of entries in cache'
)

cache_hit_rate_percent = Gauge(
    'eidolon_cache_hit_rate_percent',
    'Cache hit rate as percentage'
)

cache_evictions_total = Counter(
    'eidolon_cache_evictions_total',
...
db_connections_active = Gauge(
    'eidolon_db_connections_active',
    'Number of active database connections'
)

db_connection_errors_total = Counter(
    'eidolon_db_connection_errors_total',
...
git_operation_duration_seconds = Histogram(
    'eidolon_git_operation_duration_seconds',
...
process_cpu_percent = Gauge(
    'eidolon_process_cpu_percent',
    'CPU usage percentage of Eidolon process'
)

process_memory_bytes = Gauge(
    'eidolon_process_memory_bytes',
    'Memory usage in bytes of Eidolon process',
    ['type']  # type: rss/vms/shared
)

process_open_files = Gauge(
    'eidolon_process_open_files',
    'Number of open file descriptors'
)

system_disk_usage_percent = Gauge(
    'eidolon_system_disk_usage_percent',
    'System disk usage percentage'
)

system_memory_usage_percent = Gauge(
    'eidolon_system_memory_usage_percent',
...
http_request_duration_seconds = Histogram(
    'eidolon_http_request_duration_seconds',
...
http_requests_in_progress = Gauge(
    'eidolon_http_requests_in_progress',
