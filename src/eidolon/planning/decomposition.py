...
from eidolon.planning.agent_selector import IntelligentAgentSelector, AgentRole
...
class SystemDecomposer:
    ...
    def __init__(
        ...
        # Phase 3: Review loop
        if use_review_loop:
            from eidolon.planning.review_loop import ReviewLoop
    ...
    async def _decompose_internal(
        ...
        while turn < max_turns:
            ...
            try:
                ...
                if use_design_tools:
                    from eidolon.design_context_tools import DESIGN_CONTEXT_TOOLS
    ...
    async def _generate_code_internal(
        ...
        while turn < max_turns:
            ...
            try:
                ...
                if use_tools:
                    from eidolon.code_context_tools import CODE_CONTEXT_TOOLS
